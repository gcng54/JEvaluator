 ...
 */
public enum ESpeedUnit implements IUnit<ESpeedUnit> {
   ...
   */
  ESpeedUnit(String symbol, double factor) {
   ...
   */
  public static ESpeedUnit fromName(@NotNull String name_) { return ESpeedUnit.valueOf(name_.toUpperCase(Locale.ENGLISH)); }
