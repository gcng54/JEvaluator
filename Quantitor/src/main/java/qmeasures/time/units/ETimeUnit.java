 ...
 */
public enum ETimeUnit implements IUnit<ETimeUnit> {
	 ...
	 */
	ETimeUnit(String symbol, double factor) {
	 ...
	 */
	@Override public ETimeUnit getBaseUnit() { return SECOND; }
	 ...
	 */
	public static ETimeUnit fromName(String name_) {
		return ETimeUnit.valueOf(name_.toUpperCase(Locale.ENGLISH));
	}
