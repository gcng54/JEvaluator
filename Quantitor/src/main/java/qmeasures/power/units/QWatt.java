 ...
 */
public class QWatt extends APower<QWatt> {

    /**
     * Constructs a time quantity in seconds.
     * @param value the value in seconds
     */
    public QWatt(double value) { super(value, EPowerUnit.WATT, EPowerDims.POWER);  }
     ...
     */
    @Override  public QWatt of(double value, EPowerUnit unit) { return new QWatt(value);  }
