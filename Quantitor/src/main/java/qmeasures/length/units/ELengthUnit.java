 ...
 */
public enum ELengthUnit implements IUnit<ELengthUnit> {
  /** Meter (base unit) */
  METER("m", 1.0),
  /** Kilometer */
   ...
   */
  ELengthUnit(String symbol, double factor) {
   ...
   */
  public static ELengthUnit fromName(String name_) {
    return ELengthUnit.valueOf(name_.toUpperCase(Locale.ENGLISH));
  }
